...
package Google::Ads::AdWords::v201302::ManagedCustomerService::mutateManager;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201302::MoveOperation',
    },
    {
...
Google::Ads::AdWords::v201302::ManagedCustomerService::mutateManager

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
mutateManager from the namespace https://adwords.google.com/api/adwords/mcm/v201302.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201302::ManagedCustomerService::mutateManager->new($data);
