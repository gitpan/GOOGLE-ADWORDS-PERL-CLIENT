package Google::Ads::AdWords::v201302::BiddingTransition;
use strict;
use warnings;
...
Google::Ads::AdWords::v201302::BiddingTransition

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BiddingTransition from the namespace https://adwords.google.com/api/adwords/cm/v201302.
