package Google::Ads::AdWords::v201302::OperationStream;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'scopingEntityId' => 'Google::Ads::AdWords::v201302::EntityId',
...
OperationStream from the namespace https://adwords.google.com/api/adwords/cm/v201302.
