package Google::Ads::AdWords::v201302::PercentCPA;
use strict;
use warnings;
...
Google::Ads::AdWords::v201302::PercentCPA

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
PercentCPA from the namespace https://adwords.google.com/api/adwords/cm/v201302.
