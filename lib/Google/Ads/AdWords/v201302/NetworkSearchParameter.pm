package Google::Ads::AdWords::v201302::NetworkSearchParameter;
use strict;
use warnings;
...
Google::Ads::AdWords::v201302::NetworkSearchParameter

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
NetworkSearchParameter from the namespace https://adwords.google.com/api/adwords/o/v201302.
