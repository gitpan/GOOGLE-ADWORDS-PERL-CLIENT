package Google::Ads::AdWords::v201302::ConversionOptimizer;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'pricingModel' => 'Google::Ads::AdWords::v201302::PricingModel',
        'conversionOptimizerBidType' => 'Google::Ads::AdWords::v201302::ConversionOptimizerBidType',
    },
    {
...
Google::Ads::AdWords::v201302::ConversionOptimizer

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ConversionOptimizer from the namespace https://adwords.google.com/api/adwords/cm/v201302.
