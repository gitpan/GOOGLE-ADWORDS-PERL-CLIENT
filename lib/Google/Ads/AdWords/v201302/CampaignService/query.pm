...
package Google::Ads::AdWords::v201302::CampaignService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201302::CampaignService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201302::CampaignService::query->new($data);
