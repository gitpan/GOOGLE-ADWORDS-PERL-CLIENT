package Google::Ads::AdWords::v201302::ManualCPMAdGroupBids;
use strict;
use warnings;
...
Google::Ads::AdWords::v201302::ManualCPMAdGroupBids

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ManualCPMAdGroupBids from the namespace https://adwords.google.com/api/adwords/cm/v201302.
