package Google::Ads::AdWords::v201209::LostResult;
use strict;
use warnings;
...
Google::Ads::AdWords::v201209::LostResult

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
LostResult from the namespace https://adwords.google.com/api/adwords/cm/v201209.
