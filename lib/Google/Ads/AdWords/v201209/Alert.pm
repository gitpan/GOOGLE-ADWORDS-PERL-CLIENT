package Google::Ads::AdWords::v201209::Alert;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'alertSeverity' => 'Google::Ads::AdWords::v201209::AlertSeverity',
        'alertType' => 'Google::Ads::AdWords::v201209::AlertType',
        'clientCustomerId' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'details' => 'Google::Ads::AdWords::v201209::Detail',
    },
    {
...
Google::Ads::AdWords::v201209::Alert

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Alert from the namespace https://adwords.google.com/api/adwords/mcm/v201209.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201209::Alert
   ...
   details =>  $a_reference_to, # see Google::Ads::AdWords::v201209::Detail
 },
