package Google::Ads::AdWords::v201209::ExcludedKeywordSearchParameter;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'keywords' => 'Google::Ads::AdWords::v201209::Keyword',
    },
    {
...
Google::Ads::AdWords::v201209::ExcludedKeywordSearchParameter

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ExcludedKeywordSearchParameter from the namespace https://adwords.google.com/api/adwords/o/v201209.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201209::ExcludedKeywordSearchParameter
   keywords =>  $a_reference_to, # see Google::Ads::AdWords::v201209::Keyword
 },
