package Google::Ads::AdWords::v201209::UserList;
use strict;
use warnings;
...
Google::Ads::AdWords::v201209::UserList

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
UserList from the namespace https://adwords.google.com/api/adwords/cm/v201209.
