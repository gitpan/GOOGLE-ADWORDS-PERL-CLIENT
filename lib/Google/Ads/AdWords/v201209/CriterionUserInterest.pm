package Google::Ads::AdWords::v201209::CriterionUserInterest;
use strict;
use warnings;
...
Google::Ads::AdWords::v201209::CriterionUserInterest

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CriterionUserInterest from the namespace https://adwords.google.com/api/adwords/cm/v201209.
