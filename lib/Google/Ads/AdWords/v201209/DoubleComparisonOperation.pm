package Google::Ads::AdWords::v201209::DoubleComparisonOperation;
use strict;
use warnings;
...
Google::Ads::AdWords::v201209::DoubleComparisonOperation

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DoubleComparisonOperation from the namespace https://adwords.google.com/api/adwords/o/v201209.
