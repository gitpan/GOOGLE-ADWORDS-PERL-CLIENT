package Google::Ads::AdWords::v201209::ApiUsageRecord;
use strict;
use warnings;
...
Google::Ads::AdWords::v201209::ApiUsageRecord

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ApiUsageRecord from the namespace https://adwords.google.com/api/adwords/info/v201209.
