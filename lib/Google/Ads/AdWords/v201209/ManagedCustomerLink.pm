package Google::Ads::AdWords::v201209::ManagedCustomerLink;
use strict;
use warnings;
...
Google::Ads::AdWords::v201209::ManagedCustomerLink

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ManagedCustomerLink from the namespace https://adwords.google.com/api/adwords/mcm/v201209.
