package Google::Ads::AdWords::v201209::CriterionPolicyError;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201209::PolicyViolationError);
# Variety: sequence
...
Google::Ads::AdWords::v201209::CriterionPolicyError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CriterionPolicyError from the namespace https://adwords.google.com/api/adwords/cm/v201209.
