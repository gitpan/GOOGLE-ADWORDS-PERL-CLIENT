package Google::Ads::AdWords::v201209::Campaign;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'status' => 'Google::Ads::AdWords::v201209::CampaignStatus',
        'servingStatus' => 'Google::Ads::AdWords::v201209::ServingStatus',
        'startDate' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'endDate' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'budget' => 'Google::Ads::AdWords::v201209::Budget',
        'biddingStrategy' => 'Google::Ads::AdWords::v201209::BiddingStrategy',
        'conversionOptimizerEligibility' => 'Google::Ads::AdWords::v201209::ConversionOptimizerEligibility',
        'campaignStats' => 'Google::Ads::AdWords::v201209::CampaignStats',
        'adServingOptimizationStatus' => 'Google::Ads::AdWords::v201209::AdServingOptimizationStatus',
        'frequencyCap' => 'Google::Ads::AdWords::v201209::FrequencyCap',
        'settings' => 'Google::Ads::AdWords::v201209::Setting',
        'networkSetting' => 'Google::Ads::AdWords::v201209::NetworkSetting',
...
Google::Ads::AdWords::v201209::Campaign

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Campaign from the namespace https://adwords.google.com/api/adwords/cm/v201209.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201209::Campaign
   ...
   biddingStrategy =>  $a_reference_to, # see Google::Ads::AdWords::v201209::BiddingStrategy
   conversionOptimizerEligibility =>  $a_reference_to, # see Google::Ads::AdWords::v201209::ConversionOptimizerEligibility
   campaignStats =>  $a_reference_to, # see Google::Ads::AdWords::v201209::CampaignStats
   adServingOptimizationStatus => $some_value, # AdServingOptimizationStatus
   frequencyCap =>  $a_reference_to, # see Google::Ads::AdWords::v201209::FrequencyCap
   settings =>  $a_reference_to, # see Google::Ads::AdWords::v201209::Setting
   networkSetting =>  $a_reference_to, # see Google::Ads::AdWords::v201209::NetworkSetting
