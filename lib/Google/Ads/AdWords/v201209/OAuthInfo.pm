package Google::Ads::AdWords::v201209::OAuthInfo;
use strict;
use warnings;
...
Google::Ads::AdWords::v201209::OAuthInfo

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
OAuthInfo from the namespace https://adwords.google.com/api/adwords/cm/v201209.
