package Google::Ads::AdWords::v201209::TargetRestrictSetting;
use strict;
use warnings;
...
Google::Ads::AdWords::v201209::TargetRestrictSetting

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
TargetRestrictSetting from the namespace https://adwords.google.com/api/adwords/cm/v201209.
