package Google::Ads::AdWords::v201209::AdExtensionOverrideService::AdExtensionOverrideServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201209::TypeMaps::AdExtensionOverrideService
    if not Google::Ads::AdWords::v201209::TypeMaps::AdExtensionOverrideService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201209/AdExtensionOverrideService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201209::TypeMaps::AdExtensionOverrideService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201209::AdExtensionOverrideService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201209::AdExtensionOverrideService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201209::AdExtensionOverrideService::mutate )],
        },
        header => {
...
located at https://adwords.google.com/api/adwords/cm/v201209/AdExtensionOverrideService.
...
Returns a L<Google::Ads::AdWords::v201209::AdExtensionOverrideService::getResponse|Google::Ads::AdWords::v201209::AdExtensionOverrideService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201209::AdExtensionOverrideService::mutateResponse|Google::Ads::AdWords::v201209::AdExtensionOverrideService::mutateResponse> object.
...
Generated by SOAP::WSDL on Tue Mar  5 13:51:31 2013
