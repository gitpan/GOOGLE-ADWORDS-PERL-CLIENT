package Google::Ads::AdWords::v201209::BulkMutateJob;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'policy' => 'Google::Ads::AdWords::v201209::BulkMutateJobPolicy',
        'request' => 'Google::Ads::AdWords::v201209::BulkMutateRequest',
        'status' => 'Google::Ads::AdWords::v201209::BasicJobStatus',
        'history' => 'Google::Ads::AdWords::v201209::BulkMutateJobEvent',
        'result' => 'Google::Ads::AdWords::v201209::BulkMutateResult',
...
Google::Ads::AdWords::v201209::BulkMutateJob

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BulkMutateJob from the namespace https://adwords.google.com/api/adwords/cm/v201209.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201209::BulkMutateJob
   ...
   request =>  $a_reference_to, # see Google::Ads::AdWords::v201209::BulkMutateRequest
   status => $some_value, # BasicJobStatus
   history =>  $a_reference_to, # see Google::Ads::AdWords::v201209::BulkMutateJobEvent
   result =>  $a_reference_to, # see Google::Ads::AdWords::v201209::BulkMutateResult
