package Google::Ads::AdWords::v201209::MediaPage;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'entries' => 'Google::Ads::AdWords::v201209::Media',
...
Google::Ads::AdWords::v201209::MediaPage

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
MediaPage from the namespace https://adwords.google.com/api/adwords/cm/v201209.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201209::MediaPage
   entries =>  $a_reference_to, # see Google::Ads::AdWords::v201209::Media
