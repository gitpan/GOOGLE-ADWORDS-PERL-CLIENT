package Google::Ads::AdWords::v201209::BatchFailureResult;
use strict;
use warnings;
...
Google::Ads::AdWords::v201209::BatchFailureResult

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BatchFailureResult from the namespace https://adwords.google.com/api/adwords/cm/v201209.
