package Google::Ads::AdWords::v201209::ManualCPC;
use strict;
use warnings;
...
Google::Ads::AdWords::v201209::ManualCPC

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ManualCPC from the namespace https://adwords.google.com/api/adwords/cm/v201209.
