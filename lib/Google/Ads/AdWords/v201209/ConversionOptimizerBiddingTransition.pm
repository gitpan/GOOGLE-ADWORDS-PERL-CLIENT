package Google::Ads::AdWords::v201209::ConversionOptimizerBiddingTransition;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201209::BiddingTransition);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    {
        'targetBiddingStrategy' => 'Google::Ads::AdWords::v201209::BiddingStrategy',
...
Google::Ads::AdWords::v201209::ConversionOptimizerBiddingTransition

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ConversionOptimizerBiddingTransition from the namespace https://adwords.google.com/api/adwords/cm/v201209.
