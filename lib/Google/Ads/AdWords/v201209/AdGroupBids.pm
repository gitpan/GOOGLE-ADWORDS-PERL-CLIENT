package Google::Ads::AdWords::v201209::AdGroupBids;
use strict;
use warnings;
...
Google::Ads::AdWords::v201209::AdGroupBids

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupBids from the namespace https://adwords.google.com/api/adwords/cm/v201209.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201209::AdGroupBids
   interactionBids =>  $a_reference_to, # see Google::Ads::AdWords::v201209::InteractionBid
