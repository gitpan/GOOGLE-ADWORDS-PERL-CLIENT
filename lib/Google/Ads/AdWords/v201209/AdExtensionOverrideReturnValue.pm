package Google::Ads::AdWords::v201209::AdExtensionOverrideReturnValue;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'value' => 'Google::Ads::AdWords::v201209::AdExtensionOverride',
...
Google::Ads::AdWords::v201209::AdExtensionOverrideReturnValue

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdExtensionOverrideReturnValue from the namespace https://adwords.google.com/api/adwords/cm/v201209.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201209::AdExtensionOverrideReturnValue
   value =>  $a_reference_to, # see Google::Ads::AdWords::v201209::AdExtensionOverride
   partialFailureErrors =>  $a_reference_to, # see Google::Ads::AdWords::v201209::ApiError
 },
