package Google::Ads::AdWords::v201209::OverrideInfo;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'LocationOverrideInfo' => 'Google::Ads::AdWords::v201209::LocationOverrideInfo',
    },
    {
...
Google::Ads::AdWords::v201209::OverrideInfo

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
OverrideInfo from the namespace https://adwords.google.com/api/adwords/cm/v201209.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201209::OverrideInfo
   ...
   LocationOverrideInfo =>  $a_reference_to, # see Google::Ads::AdWords::v201209::LocationOverrideInfo
 },
