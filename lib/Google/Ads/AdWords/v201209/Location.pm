package Google::Ads::AdWords::v201209::Location;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'targetingStatus' => 'Google::Ads::AdWords::v201209::LocationTargetingStatus',
        'parentLocations' => 'Google::Ads::AdWords::v201209::Location',
    },
    {
...
Google::Ads::AdWords::v201209::Location

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Location from the namespace https://adwords.google.com/api/adwords/cm/v201209.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201209::Location
   ...
   parentLocations =>  $a_reference_to, # see Google::Ads::AdWords::v201209::Location
 },
