package Google::Ads::AdWords::v201209::BiddingTransition;
use strict;
use warnings;
...
Google::Ads::AdWords::v201209::BiddingTransition

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BiddingTransition from the namespace https://adwords.google.com/api/adwords/cm/v201209.
...
Constructor. The following data structure may be passed to new():
 ...
 { # Google::Ads::AdWords::v201209::BiddingTransition
   targetBiddingStrategy =>  $a_reference_to, # see Google::Ads::AdWords::v201209::BiddingStrategy
