...
use Google::Ads::AdWords::v201209::Image;
use Google::Ads::AdWords::v201209::ImageAd;
use Google::Ads::AdWords::v201209::TemplateAd;
use Google::Ads::AdWords::v201209::TextAd;
use Google::Ads::AdWords::v201209::Video;
...
sub add_text_ads {
  ...
  for(my $i = 0; $i < $num_ads; $i++) {
    # Create text ad.
    my $text_ad = Google::Ads::AdWords::v201209::TextAd->new({
    ...
    my $text_ad_group_ad = Google::Ads::AdWords::v201209::AdGroupAd->new({
    ...
    my $text_ad_group_ad_operation =
      Google::Ads::AdWords::v201209::AdGroupAdOperation->new({
        operator => "ADD",
