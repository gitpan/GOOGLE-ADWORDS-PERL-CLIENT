...
use Google::Ads::AdWords::v201209::Budget;
use Google::Ads::AdWords::v201209::BudgetOperation;
use Google::Ads::AdWords::v201209::BudgetOptimizer;
use Google::Ads::AdWords::v201209::Campaign;
use Google::Ads::AdWords::v201209::CampaignOperation;
use Google::Ads::AdWords::v201209::FrequencyCap;
use Google::Ads::AdWords::v201209::GeoTargetTypeSetting;
use Google::Ads::AdWords::v201209::KeywordMatchSetting;
use Google::Ads::AdWords::v201209::ManualCPC;
use Google::Ads::AdWords::v201209::Money;
use Google::Ads::AdWords::v201209::NetworkSetting;
use Google::Ads::AdWords::v201209::TargetRestrictSetting;
...
sub add_campaigns {
  ...
  my $ budget = Google::Ads::AdWords::v201209::Budget->new({
    # Required attributes.
    name => "Interplanetary budget #" . uniqid(),
    amount => Google::Ads::AdWords::v201209::Money->new({
      microAmount => 5000000
    }),
  ...
  my $budget_operation = Google::Ads::AdWords::v201209::BudgetOperation->new({
    operator => "ADD",
    operand => $budget
  });
  ...
  for (my $i = 0; $i < $num_campaigns; $i++) {
    ...
    my $campaign = Google::Ads::AdWords::v201209::Campaign->new({
      ...
      biddingStrategy => Google::Ads::AdWords::v201209::ManualCPC->new(),
      # Budget (required) - note only the budgetId is required.
      budget => Google::Ads::AdWords::v201209::Budget->new({
        budgetId => $budgetId
      }),
      # Network targeting (recommended).
      networkSetting => Google::Ads::AdWords::v201209::NetworkSetting->new({
      ...
      frequencyCap => Google::Ads::AdWords::v201209::FrequencyCap->new({
        impressions => 5,
        timeUnit => "DAY",
        level => "ADGROUP"
      }),
      settings => [
          ...
          Google::Ads::AdWords::v201209::TargetRestrictSetting->new({
            useAdGroup => 1
          }),
          # Advanced location targeting settings (non-required).
          Google::Ads::AdWords::v201209::GeoTargetTypeSetting->new({
            positiveGeoTargetType => "DONT_CARE",
            negativeGeoTargetType => "DONT_CARE"
          }),
          # Keyword match setting (non-required).
          Google::Ads::AdWords::v201209::KeywordMatchSetting->new({
            optIn => 0
          })
      ],
