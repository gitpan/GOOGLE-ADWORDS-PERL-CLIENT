...
use Google::Ads::AdWords::v201209::ManualCPCAdGroupCriterionBids;
use Google::Ads::AdWords::v201209::Placement;
  ...
  for(my $i = 0; $i < $num_keywords; $i++) {
    ...
    my $keyword_biddable_ad_group_criterion =
        Google::Ads::AdWords::v201209::BiddableAdGroupCriterion->new({
          ...
          bids => Google::Ads::AdWords::v201209::ManualCPCAdGroupCriterionBids->new({
            maxCpc => Google::Ads::AdWords::v201209::Bid->new({
