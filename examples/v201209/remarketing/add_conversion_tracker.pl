...
use Google::Ads::AdWords::v201209::AdWordsConversionTracker;
use Google::Ads::AdWords::v201209::ConversionTrackerOperation;
...
sub add_conversion_tracker {
  ...
  my $conversion_tracker =
      Google::Ads::AdWords::v201209::AdWordsConversionTracker->new({
  ...
  my $conversion_operation =
      Google::Ads::AdWords::v201209::ConversionTrackerOperation->new({
        operator => "ADD",
