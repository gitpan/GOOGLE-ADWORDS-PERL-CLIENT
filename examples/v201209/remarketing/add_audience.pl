...
use Google::Ads::AdWords::v201209::Predicate;
use Google::Ads::AdWords::v201209::RemarketingUserList;
use Google::Ads::AdWords::v201209::Selector;
use Google::Ads::AdWords::v201209::UserListConversionType;
use Google::Ads::AdWords::v201209::UserListOperation;
...
sub add_audience {
  ...
  my $conversion_type =
      Google::Ads::AdWords::v201209::UserListConversionType->new({
          name => $name
      });

  # Create remarketing user list.
  my $user_list = Google::Ads::AdWords::v201209::RemarketingUserList->new({
    name => $name,
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201209::UserListOperation->new({
    operator => "ADD",
    operand => $user_list
  });
  ...
  if ($result->get_value()) {
    ...
    sleep(5);
    my $predicate = Google::Ads::AdWords::v201209::Predicate->new({
      field => "Id",
      operator => "IN",
      values => [$user_list->get_id()->get_value()]
    });
    my $selector = Google::Ads::AdWords::v201209::Selector->new({
    ...
    my $conversion_type_predicate =
        Google::Ads::AdWords::v201209::Predicate->new({
          field => "Id",
          operator => "IN",
          values => [$conversion_id]
        });
    $selector = Google::Ads::AdWords::v201209::Selector->new({
      fields => ["Id"],
