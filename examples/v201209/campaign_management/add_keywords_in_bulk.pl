...
use Google::Ads::AdWords::v201209::AdGroupCriterion;
use Google::Ads::AdWords::v201209::AdGroupCriterionOperation;
use Google::Ads::AdWords::v201209::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201209::BulkMutateJobPolicy;
use Google::Ads::AdWords::v201209::BulkMutateJobSelector;
use Google::Ads::AdWords::v201209::Keyword;
use Google::Ads::AdWords::v201209::TextAd;
...
sub add_keywords_in_bulk {
  ...
  for (my $i = 1 ; $i < KEYWORD_COUNT; $i++) {
    # Create keyword.
    my $keyword = Google::Ads::AdWords::v201209::Keyword->new({
      matchType => "BROAD"
    });
  ...
  my $job = $client->MutateJobService()->mutate({
        ...
        policy => Google::Ads::AdWords::v201209::BulkMutateJobPolicy->new({
  ...
  my $job_selector = Google::Ads::AdWords::v201209::BulkMutateJobSelector->new({
    jobIds => [$job_id],
    includeStats => 1,
    includeHistory => 1
  });
