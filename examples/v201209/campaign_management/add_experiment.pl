...
use Google::Ads::AdWords::v201209::AdGroup;
use Google::Ads::AdWords::v201209::AdGroupAd;
use Google::Ads::AdWords::v201209::AdGroupAdOperation;
use Google::Ads::AdWords::v201209::AdGroupCriterionOperation;
use Google::Ads::AdWords::v201209::AdGroupExperimentData;
use Google::Ads::AdWords::v201209::AdGroupOperation;
use Google::Ads::AdWords::v201209::BidMultiplier;
use Google::Ads::AdWords::v201209::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201209::BiddableAdGroupCriterionExperimentData;
use Google::Ads::AdWords::v201209::Criterion;
use Google::Ads::AdWords::v201209::Experiment;
use Google::Ads::AdWords::v201209::ExperimentOperation;
use Google::Ads::AdWords::v201209::ManualCPCAdGroupCriterionExperimentBidMultiplier;
use Google::Ads::AdWords::v201209::ManualCPCAdGroupExperimentBidMultipliers;
...
sub add_experiment {
  ...
  my $end_time = sprintf("%d%02d%02d %02d%02d%02d", ($year + 1900),
      ($mon + 1), $mday, $hour, $min, $sec);
  my $experiment = Google::Ads::AdWords::v201209::Experiment->new({
  ...
  my $experiment_operation =
      Google::Ads::AdWords::v201209::ExperimentOperation->new({
        operator => "ADD",
        operand => $experiment
      });
  ...
  my $ad_group = Google::Ads::AdWords::v201209::AdGroup->new({
    id => $ad_group_id
  });
  ...
  # experiment.
  my $bid_multiplier =
      Google::Ads::AdWords::v201209::ManualCPCAdGroupExperimentBidMultipliers->
          new({
            maxCpcMultiplier => Google::Ads::AdWords::v201209::BidMultiplier->
                new({
                  multiplier => 1.5
                })
          });
  ...
  my $experiment_data =
      Google::Ads::AdWords::v201209::AdGroupExperimentData->new({
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201209::AdGroupOperation->new({
    operand => $ad_group,
    operator => "SET"
  });
  ...
  my $criterion = Google::Ads::AdWords::v201209::Criterion->new({
    id => $criterion_id,
  });

  my $ad_group_criterion =
      Google::Ads::AdWords::v201209::BiddableAdGroupCriterion->new({
  ...
  # experiment.
  $bid_multiplier =
      Google::Ads::AdWords::v201209::ManualCPCAdGroupCriterionExperimentBidMultiplier->new({
        maxCpcMultiplier => Google::Ads::AdWords::v201209::BidMultiplier->new({
          multiplier => 1.5
        })
      });
  ...
  $experiment_data =
      Google::Ads::AdWords::v201209::BiddableAdGroupCriterionExperimentData->
          new({
            experimentId => $experiment_id,
            experimentDeltaStatus => "MODIFIED",
  ...
  # Create operation.
  $operation =
      Google::Ads::AdWords::v201209::AdGroupCriterionOperation->new({
