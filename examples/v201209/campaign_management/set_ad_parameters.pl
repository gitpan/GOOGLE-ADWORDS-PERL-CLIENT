...
use Google::Ads::AdWords::v201209::AdParam;
use Google::Ads::AdWords::v201209::AdParamOperation;
...
sub set_ad_parameters {
  ...
  my $ad_param1 = Google::Ads::AdWords::v201209::AdParam->new({
  ...
  my $ad_param2 = Google::Ads::AdWords::v201209::AdParam->new({
    adGroupId => $ad_group_id,
    criterionId => $keyword_id,
    insertionText => "\$40",
    paramIndex => "2",
  ...
  my $ad_param_operation1 =
      Google::Ads::AdWords::v201209::AdParamOperation->new({
        operator => "SET",
        operand => $ad_param1
      });
