...
use Google::Ads::AdWords::v201209::Address;
use Google::Ads::AdWords::v201209::CampaignAdExtension;
use Google::Ads::AdWords::v201209::CampaignAdExtensionOperation;
use Google::Ads::AdWords::v201209::GeoLocationSelector;
use Google::Ads::AdWords::v201209::LocationExtension;
...
sub add_location_extension {
  ...
  # Create address.
  my $address = Google::Ads::AdWords::v201209::Address->new({
  ...
  my $selector = Google::Ads::AdWords::v201209::GeoLocationSelector->new({
    addresses => [$address]
  });
  ...
  my $location_extension =
      Google::Ads::AdWords::v201209::LocationExtension->new({
  ...
  my $campaign_location_ad_extension =
      Google::Ads::AdWords::v201209::CampaignAdExtension->new({
  ...
  # Create operation.
  my $operation =
      Google::Ads::AdWords::v201209::CampaignAdExtensionOperation->new({
