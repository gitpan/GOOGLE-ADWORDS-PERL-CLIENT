...
use Google::Ads::AdWords::v201209::RelatedToQuerySearchParameter;
use Google::Ads::AdWords::v201209::TargetingIdeaSelector;
...
sub get_keyword_ideas {
  ...
  # Create selector.
  my $selector = Google::Ads::AdWords::v201209::TargetingIdeaSelector->new({
    requestType => "IDEAS",
    ideaType => "KEYWORD",
  ...
  my $query_search_parameter =
      Google::Ads::AdWords::v201209::RelatedToQuerySearchParameter->new({
        queries => [$seed_query]
      });
