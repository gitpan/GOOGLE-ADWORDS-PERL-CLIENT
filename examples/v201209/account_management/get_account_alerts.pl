...
use Google::Ads::AdWords::v201209::AlertQuery;
use Google::Ads::AdWords::v201209::AlertSelector;
...
sub get_account_alerts {
  ...
  # Create alert query.
  my $alert_query = new Google::Ads::AdWords::v201209::AlertQuery({
    clientSpec => "ALL",
    filterSpec => "ALL",
  ...
  my $selector = Google::Ads::AdWords::v201209::AlertSelector->new({
    query => $alert_query,
    paging => $paging
  });
