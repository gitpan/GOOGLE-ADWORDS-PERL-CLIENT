...
use Google::Ads::AdWords::v201209::ManagedCustomer;
use Google::Ads::AdWords::v201209::ManagedCustomerOperation;
...
sub create_account {
  ...
  my $account = Google::Ads::AdWords::v201209::ManagedCustomer->new({
  ...
  my $operation = Google::Ads::AdWords::v201209::ManagedCustomerOperation->new({
    operator        => "ADD",
    operand         => $account
  });
