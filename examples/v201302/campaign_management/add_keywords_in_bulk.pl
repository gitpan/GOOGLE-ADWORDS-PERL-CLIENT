...
use Google::Ads::AdWords::v201302::AdGroupCriterion;
use Google::Ads::AdWords::v201302::AdGroupCriterionOperation;
use Google::Ads::AdWords::v201302::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201302::BulkMutateJobPolicy;
use Google::Ads::AdWords::v201302::BulkMutateJobSelector;
use Google::Ads::AdWords::v201302::Keyword;
use Google::Ads::AdWords::v201302::TextAd;
...
sub add_keywords_in_bulk {
  ...
  for (my $i = 1 ; $i < KEYWORD_COUNT; $i++) {
    # Create keyword.
    my $keyword = Google::Ads::AdWords::v201302::Keyword->new({
      matchType => "BROAD"
    });
  ...
  my $job = $client->MutateJobService()->mutate({
        ...
        policy => Google::Ads::AdWords::v201302::BulkMutateJobPolicy->new({
  ...
  my $job_selector = Google::Ads::AdWords::v201302::BulkMutateJobSelector->new({
    jobIds => [$job_id],
    includeStats => 1,
    includeHistory => 1
  });
