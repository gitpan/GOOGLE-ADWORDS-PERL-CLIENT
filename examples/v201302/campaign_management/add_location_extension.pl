...
use Google::Ads::AdWords::v201302::Address;
use Google::Ads::AdWords::v201302::CampaignAdExtension;
use Google::Ads::AdWords::v201302::CampaignAdExtensionOperation;
use Google::Ads::AdWords::v201302::GeoLocationSelector;
use Google::Ads::AdWords::v201302::LocationExtension;
...
sub add_location_extension {
  ...
  # Create address.
  my $address = Google::Ads::AdWords::v201302::Address->new({
  ...
  my $selector = Google::Ads::AdWords::v201302::GeoLocationSelector->new({
    addresses => [$address]
  });
  ...
  my $location_extension =
      Google::Ads::AdWords::v201302::LocationExtension->new({
  ...
  my $campaign_location_ad_extension =
      Google::Ads::AdWords::v201302::CampaignAdExtension->new({
  ...
  # Create operation.
  my $operation =
      Google::Ads::AdWords::v201302::CampaignAdExtensionOperation->new({
