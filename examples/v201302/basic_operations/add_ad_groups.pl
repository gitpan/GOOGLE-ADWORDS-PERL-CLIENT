...
use Google::Ads::AdWords::v201302::CpcBid;
use Google::Ads::AdWords::v201302::Money;
use Google::Ads::AdWords::v201302::TargetingSetting;
use Google::Ads::AdWords::v201302::TargetingSettingDetail;
  ...
  for (my $i = 0; $i < $num_ad_groups; $i++) {
    ...
    my $ad_group = Google::Ads::AdWords::v201302::AdGroup->new({
          ...
          Google::Ads::AdWords::v201302::BiddingStrategyConfiguration->new({
            bids => [
              Google::Ads::AdWords::v201302::CpcBid->new({
                ...
                contentBid => Google::Ads::AdWords::v201302::Money->new({
                  microAmount => 750000
                }),
              }),
            ]
      ...
      settings => [
        ...
        Google::Ads::AdWords::v201302::TargetingSetting->new({
          details => [
            # Restricting to serve ads that match your ad group placements.
            Google::Ads::AdWords::v201302::TargetingSettingDetail->new({
    ...
    my $ad_group_operation =
        Google::Ads::AdWords::v201302::AdGroupOperation->new({
          operator => "ADD",
          operand => $ad_group
        });
