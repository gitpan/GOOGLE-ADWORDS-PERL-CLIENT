...
use Google::Ads::AdWords::v201302::BudgetOperation;
use Google::Ads::AdWords::v201302::BudgetOptimizer;
use Google::Ads::AdWords::v201302::Campaign;
use Google::Ads::AdWords::v201302::CampaignOperation;
use Google::Ads::AdWords::v201302::FrequencyCap;
use Google::Ads::AdWords::v201302::GeoTargetTypeSetting;
use Google::Ads::AdWords::v201302::KeywordMatchSetting;
use Google::Ads::AdWords::v201302::ManualCpcBiddingScheme;
use Google::Ads::AdWords::v201302::Money;
use Google::Ads::AdWords::v201302::NetworkSetting;
...
sub add_campaigns {
  ...
  my $budget_operation = Google::Ads::AdWords::v201302::BudgetOperation->new({
    operator => "ADD",
    operand => $budget
  });
  ...
  for (my $i = 0; $i < $num_campaigns; $i++) {
    ...
    my $campaign = Google::Ads::AdWords::v201302::Campaign->new({
      ...
      budget => Google::Ads::AdWords::v201302::Budget->new({
        budgetId => $budgetId
      }),
      # Network targeting (recommended).
      networkSetting => Google::Ads::AdWords::v201302::NetworkSetting->new({
      ...
      frequencyCap => Google::Ads::AdWords::v201302::FrequencyCap->new({
        impressions => 5,
        timeUnit => "DAY",
        level => "ADGROUP"
      }),
      settings => [
          ...
          Google::Ads::AdWords::v201302::GeoTargetTypeSetting->new({
            positiveGeoTargetType => "DONT_CARE",
            negativeGeoTargetType => "DONT_CARE"
          }),
          # Keyword match setting (non-required).
          Google::Ads::AdWords::v201302::KeywordMatchSetting->new({
            optIn => 0
          })
      ],
    ...
    my $campaign_operation =
        Google::Ads::AdWords::v201302::CampaignOperation->new({
          operator => "ADD",
          operand => $campaign
        });
