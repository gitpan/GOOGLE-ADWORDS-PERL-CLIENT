...
use Google::Ads::AdWords::v201302::Image;
use Google::Ads::AdWords::v201302::ImageAd;
use Google::Ads::AdWords::v201302::TemplateAd;
use Google::Ads::AdWords::v201302::TextAd;
use Google::Ads::AdWords::v201302::Video;
...
sub add_text_ads {
  ...
  for(my $i = 0; $i < $num_ads; $i++) {
    # Create text ad.
    my $text_ad = Google::Ads::AdWords::v201302::TextAd->new({
    ...
    my $text_ad_group_ad = Google::Ads::AdWords::v201302::AdGroupAd->new({
