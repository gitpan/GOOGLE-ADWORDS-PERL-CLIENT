...
use Google::Ads::AdWords::v201302::ManagedCustomer;
use Google::Ads::AdWords::v201302::ManagedCustomerOperation;
...
sub create_account {
  ...
  my $account = Google::Ads::AdWords::v201302::ManagedCustomer->new({
  ...
  my $operation = Google::Ads::AdWords::v201302::ManagedCustomerOperation->new({
    operator        => "ADD",
    operand         => $account
  });
