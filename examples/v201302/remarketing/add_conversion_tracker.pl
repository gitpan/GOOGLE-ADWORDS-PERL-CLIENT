...
use Google::Ads::AdWords::v201302::AdWordsConversionTracker;
use Google::Ads::AdWords::v201302::ConversionTrackerOperation;
...
sub add_conversion_tracker {
  ...
  my $conversion_tracker =
      Google::Ads::AdWords::v201302::AdWordsConversionTracker->new({
  ...
  my $conversion_operation =
      Google::Ads::AdWords::v201302::ConversionTrackerOperation->new({
        operator => "ADD",
